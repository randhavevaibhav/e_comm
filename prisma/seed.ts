...
async function main() {
  ...
  const productData: Prisma.ProductCreateManyInput[] = [
    // Shirts
    {
      ...
      imageUrl:
        "https://media.istockphoto.com/id/515750480/photo/mans-white-t-shirt.webp?a=1&b=1&s=612x612&w=0&k=20&c=TvaSaWNScsBIDi_EkImGadVKJPhAmV0BucEetjLZQHs=",
    },
    {
      ...
      imageUrl:
        "https://media.istockphoto.com/id/171283591/photo/african-american-woman-smiling-with-hands-in-pockets-isolated.webp?a=1&b=1&s=612x612&w=0&k=20&c=fWwBHcpRk_wPhLUGhflUhZxMRoH-TUEtqLjLfEO7u5U=",
    },
    {
      ...
      imageUrl:
        "https://media.istockphoto.com/id/1338015450/photo/photo-of-cool-brunet-little-boy-wear-blue-t-shirt-isolated-on-teal-color-background.webp?a=1&b=1&s=612x612&w=0&k=20&c=uD9OuJQMYnrG6wqziWg-wCUyCPc82FxA828voUtjM40=",
    },
    // Pants
    {
    ...
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1631112213238-b1bafeaecff3?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fEhpZ2gtV2Fpc3RlZCUyMEJsdWUlMjBKZWFuc3xlbnwwfDB8MHx8fDA%3D",
    },
    {
