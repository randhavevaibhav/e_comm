export const GUEST_CHECKOUT_FORM_ERRORS = {
  invalidEmail: "Please enter valid email.",
  requiredGuestName: "Guest name cannot be empty.",
  miniGuestName: "Guest name must have 5 characters.",
  ...
  maxBillingAdd: "Billing address can not exceed 70 characters.",
  requiredShippingAdd: "Shipping address name cannot be empty.",
  miniShippingAdd: "Shipping address must have 5 characters.",
  maxShippingAdd: "Shipping address can not exceed 70 characters.",
};